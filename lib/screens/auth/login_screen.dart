          ...
          onPressedFunction: () async {
            ...
            _firebaseMessaging.getToken().then((token) async {
              ...
              final results = await _services.get(
                '${Utils.LOGIN_URL}?user_phone=$_userPhone&user_pass=$_userPassword&lang=${_appState.currentLang}&token=$token&user_type=user',
              );
              ...
              if (results['response'] == "1") {
                ...
                _authState.setUserPhone(results['user_phone']);
